...
namespace WHS.Core.Dto.Transfer
{
    public class TransferDto
    {
        ...
        public string ExecDateVN => ExecDate.HasValue ? ExecDate.Value.ToString("dd/MM/yyyy") : "";
        public string PlanWarehouseDateVN => PlanWarehouseDate.ToString("dd/MM/yyyy");
        public string WarehouseDateVN => WarehouseDate.HasValue ? WarehouseDate.Value.ToString("dd/MM/yyyy") : "";
