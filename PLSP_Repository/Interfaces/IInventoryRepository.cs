...
{
    public interface IInventoryRepository<T, D>
        where T : class
        where D : class
    {
        /// <summary>
        ...
        /// <summary>
        /// Lấy ra danh sách tồn kho block theo phân trang
        /// </summary>
        /// <param name="paginate"></param>
        /// <param name="mo"></param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        Task<Response<List<D>>> UpdateLocationNpl(int splitId, int nplId, E_NPLType nplType, E_WHType whType, List<LocationDto> locations);
