...
namespace WHS.Repository.Repository.Vehicle
{
    public class VehicleRepository : BaseRepository, IVehicleRepository
    {
        ...
        public async Task<Response<int>> CreateVehicleAsync(VehicleDto vehicle)
        {
            ...
            try
            {
                string sql = @"insert into sys_vehicle (id, vehicle_type, vehicle_mode, license_plate, seal_number, capacity, created_by, modified_by, factory_id)
                            values (@ID, @VehicleType, @VehicleMode, @licensePlate, @SealNumber, @Capacity, @CreatedBy, @CreatedBy, @FactoryID)
                            ";
        ...
        public async Task<Response<List<TransferDetailVehicle>>> GetVehicleTransferDetail(E_NPLType type, int nplId)
        {
            ...
            try
            {
                ...
                where detail_type = @Type AND detail_id = @NplId and factory_id = @FactoryID";
