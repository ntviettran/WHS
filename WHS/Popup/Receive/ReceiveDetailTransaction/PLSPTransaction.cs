...
{
    public partial class PLSPTransaction : BaseTransaction
    {
        private ITransferService<PLSPCoordinationDto, PLSPTransferDetailDto> _transferService;

        public PLSPTransaction(ITransferService<PLSPCoordinationDto, PLSPTransferDetailDto> transferService)
        {
            InitializeComponent();
        ...
        private void PLSPTransaction_Load(object sender, EventArgs e)
        {
        ...
        protected override async void InitGridView()
        {
            ...
            Response<List<PLSPCoordinationDto>> res = await _transferService.GetCoordinationHistory(search);
