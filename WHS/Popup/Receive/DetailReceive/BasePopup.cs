...
namespace WHS.Popup.Receive.DetailReceive
{
    ...
    public class BasePopup : Form
    {
        ...
        public void Initialize(E_StatusForm statusForm, GroupReceiveDto? groupReceiveDto)
        {
        ...
        public static DataTable ConvertToDataTable<T>(List<T> items)
        {
            ...
            // Lấy tất cả các property public của kiểu T
            var properties = typeof(T).GetProperties();

            foreach (var prop in properties)
            {
                // Thêm cột với kiểu tương ứng
        ...
        /// </summary>
        protected void RegisterGridViewEvent()
        {
            if (_gridView != null)
            {
        ...
        /// <returns></returns>
        protected bool ValidateInput(Dictionary<string, TextBox> dict, TextBox quantityTxb)
        {
